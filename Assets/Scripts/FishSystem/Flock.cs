...
public class Flock : MonoBehaviour
{
    ...
    void Start()
    {
        // Asegurarse de que FlockManager esté inicializado
        if (FlockManager.FM == null)
        {
            Debug.LogError("FlockManager no está inicializado. Asegúrate de que exista un FlockManager en la escena.");
    ...
    void Update()
    {
        if (FlockManager.FM == null) return; // Salir si el FlockManager no está disponible
    ...
    private void ApplyRules()
    {
        ...
        {
            if (go != this.gameObject && go != null) // Validar que el objeto no sea nulo
            {
